...
- **Demo URL:** (No direct demo URL, but is the profile README)
- **Description:** This is Brennan Brown's personal repository, serving as a profile README. It contains information about his background, skills, and recent activities, including his education, technology stack, and recent blog posts. It also highlights his interest in open-source contributions and accessibility.
...
### 12. old-projects (repository)
- **Repository URL:** https://github.com/brennanbrown/old-projects
- **Demo URL:** (None)
- **Description:** This repository contains various programming projects and lessons completed between 2017 and 2019. It includes projects from Codecademy, EvolveU, Flatiron, and covers languages like Java and SQL, demonstrating a range of early programming work.
- **Technologies:** HTML, JavaScript, Python, Java, SQL

### 13. Campfire-Hugo-Theme (theme)
- **Repository URL:** https://github.com/brennanbrown/Campfire-Hugo-Theme
- **Demo URL:** https://campfire-hugo.netlify.app
- **Description:** A warm, story-focused Hugo theme designed for blogs, journals, and writing-first sites. It features readable typography, a wider content column, a pragmatic sidebar, dark/light themes with persistence, and a mobile-friendly header.
...
### 15. markdown-to-docx (website)
- **Repository URL:** https://github.com/brennanbrown/markdown-to-docx
- **Demo URL:** https://md-to-doc.netlify.app
- **Description:** A website that converts Markdown files to Microsoft Word format while preserving formatting and structure. It offers a web version (recommended) that requires no installation and processes files locally, as well as technical versions for local execution with features like batch conversion and folder structure preservation.
- **Technologies:** Python, JavaScript, HTML, CSS, Pandoc, pypandoc

### 16. retroweird (blog theme)
- **Repository URL:** https://github.com/brennanbrown/retroweird
- **Demo URL:** https://retroweird.netlify.app/
- **Description:** A maximalist, customizable blog theme for Eleventy inspired by GeoCities, MySpace, and the creative chaos of 1990s-2000s personal homepages. Features 6 pre-built themes, modular widget system, guestbook, blogroll, badge generator, and webring support while maintaining accessibility and mobile responsiveness.
- **Technologies:** Eleventy, HTML, CSS, JavaScript, Node.js, npm, Netlify, Git

### 17. evolveu (bootcamp portfolio)
- **Repository URL:** https://github.com/brennanbrown/evolveu
- **Demo URLs:** https://brennan-evolveu.netlify.app/
- **Description:** A comprehensive full-stack developer bootcamp portfolio featuring 7 modules of progressive learning in modern web development. Completed intensive program covering JavaScript, React, Python, Flask, MongoDB, and agile methodologies through hands-on projects and collaborative development.
- **Technologies:** JavaScript (ES6+), React 18, HTML5, CSS3, Bootstrap 5, Material-UI, Python 3.12, Flask 3, MongoDB, Mongoose, Jest, Pytest, Git, npm, pipenv, RESTful APIs

### 18. eink-site (theme)
- **Repository URL:** https://github.com/brennanbrown/eink.site
- **Demo URL:** https://eink.site/
- **Description:** A minimalist Jekyll-based website optimized for e-ink devices with limited processing power. Designed for maximum readability on Kindle, Kobo, and other e-ink displays with zero JavaScript, minimal CSS, and single HTTP request architecture. Features easy content management via Markdown and web-based editors.
- **Technologies:** Jekyll, HTML, CSS, Ruby, Markdown, Netlify, GitHub Pages, Git

### 19. foothills-tumblr-theme (theme)
- **Repository URL:** https://github.com/brennanbrown/foothills
- **Demo URL:** https://foothills-tumblr.netlify.app/preview/
- **Description:** A warm, accessible Tumblr theme designed for writers and community builders, featuring a mobile drawer, theme palette system, SEO optimization, pinned post styling, reblog trail support, poetry formatting, and sidebar widgets. Built with accessibility and customization as core principles.
- **Technologies:** HTML, CSS, JavaScript, Tumblr Theme System, Netlify, Git

### 20. 11ty-gamification (theme)
- **Repository URL:** https://github.com/brennanbrown/11ty-Gamification
